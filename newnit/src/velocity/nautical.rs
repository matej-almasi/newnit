...
make_unit!(FathomPerSecond, 1.828_8, Velocity);
make_unit!(CablePerSecond, 219.456, Velocity);
make_unit!(MilePerSecond, 1852.0, Velocity);

make_unit!(MilePerHour, 5.144_444_444_444_444_4E-1, Velocity);
